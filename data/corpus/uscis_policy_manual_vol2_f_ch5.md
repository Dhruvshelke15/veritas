...
_Time Limitations on Pre-Completion OPT_
...
_Time Limitations on Post-Completion OPT_
...
_Eligibility Requirements - Student_
...
_Previously Obtained STEM Degrees_
...
_Eligibility Requirements-Employer_
...
_Pre-completion OPT_

A student may submit an application for pre-completion OPT no earlier __ than 90 days before being enrolled for one full academic year, provided that the period of employment will not start prior to the completion of the full academic year.**[62]** The student must file a properly completed Form I-765 after the student’s DSO enters the OPT recommendation into SEVIS.

_Post-completion OPT_
...
[^ 76] See 8 CFR 214.2(m)(14)(iv).

[^ 77] See 8 CFR 214.2(m)(14)(iii).
...
**Visa Categories Snapshot** Requirement| **F-1**| **M-1**  
---|---|---  
...
Technical Update - Extension Application Filing Period for Science, Technology, Engineering, and Mathematics Optional Practical Training
...
POLICY ALERT - Science, Technology, Engineering, and Mathematics Optional Practical Training
...
2 USCIS-PM F.9 \- Chapter 9 - Dependents
