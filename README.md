...
Open `http://localhost:5173`. Full verification steps (tests, lint, live routing checks, eval harness) are in **[TESTING.md](TESTING.md)**. To put it on the public internet (Google Cloud Run + Vercel), see **[DEPLOYMENT.md](DEPLOYMENT.md)**.
